          ...
          <Grid container className="py-5 border" xs={12} md={12}>
            ...
            <Grid item xs={12} md={6}>
              ...
              <p className="text-light">
                ...
                We follow the customer in choosing the product for his need,
                also offering a technical after-sales service
              </p>
            </Grid>
          </Grid>
          <Grid container className="py-5 mt-5 border" xs={12} md={12}>
            ...
            <Grid item xs={12} md={6}>
              ...
              <p className="text-light">
                ...
                MISSION. */}
                Innovate ideas and paying particular attention to the
                environmental impacts of industrial production are the VIBOR'S
                mission
              </p>
            </Grid>
